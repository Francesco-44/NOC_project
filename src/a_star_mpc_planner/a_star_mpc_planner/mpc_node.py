"""
MPC tracker ROS2 node for the Unitree G1 humanoid.
...
class MPCNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('mpc_R_vx_reverse', 0.0)
        ...
        cfg = MPCConfig(
            ...
            R_vx_reverse  = float(self.get_parameter('mpc_R_vx_reverse').value),
